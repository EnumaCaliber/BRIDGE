...
# ═══════════════════════════════════════════════════════════════════════════════
# Feature-map SSIM Layer Selector
# ═══════════════════════════════════════════════════════════════════════════════
...
def main():
    ...
    parser.add_argument('--initial_ckpt', type=str, default="./rl_checkpoints/effnet/iterative/iter_2_/best_grown_model.pth")
    parser.add_argument('--start_sparsity', type=float, default=0.9923)
